	...
	*/
	...
	for _, f := range structData.Fields {
		...
		*/
		...
		function = strings.ReplaceAll(function, recv+upper, recv+upper+".("+cast+")")
	}
	mockString += fmt.Sprintf("func convert(%s %s) *mocks %s\n\n", structData.ConvertVar, paramsString, function)
